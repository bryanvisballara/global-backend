...
- `ADMIN_TRACKING_EMAIL_ALLOWLIST` opcional; si se define, solo esos correos reciben alertas de tracking admin. Si queda vacío, solo Alejandro y Erick reciben esos correos
...
- Cada actualización de tracking hecha por un admin también envía correo vía Brevo solo a Alejandro y Erick (o a la lista definida en `ADMIN_TRACKING_EMAIL_ALLOWLIST`).
